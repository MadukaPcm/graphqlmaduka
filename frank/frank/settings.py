...
SECRET_KEY = 'django-insecure-zm*13@t2b7+zt6d$mcsa5a#ppcx^40%m4qd)jix$1n0udf#inz'
...
#configurations for django_graphql backend for api creation.
GRAPHENE = {
...
AUTHENTICATION_BACKENDS = [
    ...
    #a line added for django-graphql-auth.
